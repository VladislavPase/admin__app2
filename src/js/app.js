...
(function ($, window) {
    $(document).ready(function () {
        ...
        let header__profile = $('.header__profile .header__profile--photo')


        header__profile.mouseenter(function() {
                $(this).parent().addClass('is-hover');
            })
            .mouseout(function() {
                $(this).parent().removeClass('is-hover');
            });
        header__profile.on('click', function (e) {
            e.preventDefault();
        ...
        $(document).on('click', (e) => handlersFormExist(e, '.header__profile', '_opened'));
